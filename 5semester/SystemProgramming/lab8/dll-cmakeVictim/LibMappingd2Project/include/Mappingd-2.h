...
MYLIBAPI void MyOpenFile(HANDLE* hMapping, LPSTR filePath, LPINT lSize);
MYLIBAPI void AddRow(HANDLE hMapping, struct Student newStudent, int pos);
MYLIBAPI void RemRow(HANDLE hMapping, int pos);
MYLIBAPI void PrintRow(HANDLE hMapping, int pos);
MYLIBAPI void PrintRows(HANDLE hMapping);
MYLIBAPI void CloseFile(HANDLE hMapping);
////////////////////////////// Конец файла /////////////////////////////////