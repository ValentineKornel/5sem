...
int main() {
    ...
    void *hLib = dlopen("./libMappingd.so", RTLD_NOW);
    ...
    *(void **)(&MyOpenFile) = (void (*)(int fd, char filePath[100], int* listSize)) dlsym(hLib, "MyOpenFile");
    *(void **)(&AddRow) = (void (*)(int fd, struct Student newStudent, int pos)) dlsym(hLib, "AddRow");
    *(void **)(&RemRow) = (void (*)(int fd, int pos)) dlsym(hLib, "RemRow");
    *(void **)(&PrintRow) = (void (*)(int fd, int pos)) dlsym(hLib, "PrintRow");
    *(void **)(&PrintRows) = (void (*)(int fd)) dlsym(hLib, "PrintRows");
    *(void **)(&CloseFile) = (void (*)(int fd)) dlsym(hLib, "CloseFile");
